window.onload = function () {
  ...
  sessionStorage.keyItemAlperen = 'value of alperen';
  ...
  console.log(sessionStorage.getItem('keyItemAlperen'));
  console.log(sessionStorage.getItem('keyItasdadasdemAlperen'));
  ...
  localStorage.alperen = 'talaslioglu';
